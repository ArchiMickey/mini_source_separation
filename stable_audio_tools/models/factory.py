...
def create_pretransform_from_config(pretransform_config, sample_rate):
    ...
    elif pretransform_type == "diffusers_autoencoder":
        from .pretransforms import DiffusuersAutoencoderPretransform
        pretransform = DiffusuersAutoencoderPretransform(pretransform_config["config"]["path"])

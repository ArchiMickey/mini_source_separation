...
class DiffusuersAutoencoderPretransform(Pretransform):
    def __init__(self, repo_id_or_path, model_half=False, iterate_batch=False, chunked=False):
        super().__init__(enable_grad=False, io_channels=2, is_discrete=False)
        
        from diffusers import AutoencoderOobleck
        
        model = AutoencoderOobleck.from_pretrained(repo_id_or_path)

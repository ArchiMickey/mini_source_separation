...
class BSRoformer(Fourier):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(n_fft=16, hop_length=2, return_complex=True, normalized=True)
        ...
        n_bands_down = n_bands_full // self.patch_size[1]
    ...
    def forward(self, audio: Tensor) -> Tensor:
        ...
        x = self.pad_tensor(x, self.patch_size[0])
        x = self.proj_in(x)

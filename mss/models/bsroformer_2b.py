...
class BSRoformer(Fourier):
    def __init__(
        ...
        **kwargs
        ...
        self.freq_patch = nn.Conv2d(dim, dim, kernel_size=(1, freq_patch_size), stride=(1, freq_patch_size))
        self.freq_unpatch = nn.ConvTranspose2d(dim, dim, kernel_size=(1, freq_patch_size), stride=(1, freq_patch_size))
    ...
    def forward(self, audio: Tensor) -> Tensor:
        ...
        x = self.freq_patch(x)  # shape: (b, d, t, f')
        ...
        x = self.freq_unpatch(x)  # shape: (b, d, t, f)

...
class BSRoformer92(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.pre_block = TimeFreqTransformerBlock(
        ...
        self.post_block = TimeFreqTransformerBlock(
            channels=in_channels,
            depth=pre_post_depth,
            n_heads=pre_post_heads,

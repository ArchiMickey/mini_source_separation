...
from mss.models.bandsplit_2 import BandSplit
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.bandsplit = BandSplit(
            ...
            n_fft=n_fft, 
            n_bands=n_bands,
            in_channels=audio_channels * 3,  # real + imag + mag
